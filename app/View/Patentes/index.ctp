    ...
    <table class="table table-condensed table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th>Estado
                    <?php echo $this->Paginator->sort('estado', $icon_plus, array('escape' => false)); ?>
                </th>
                <th>Tipo
                    <?php echo $this->Paginator->sort('tipo', $icon_plus, array('escape' => false)); ?>
                </th>
                <th>Número
                    <?php echo $this->Paginator->sort('numero', $icon_plus, array('escape' => false)); ?>
                </th>
                <th>Titular
                    <?php echo $this->Paginator->sort('titular', $icon_plus, array('escape' => false)); ?>
                </th>
            </tr>
        </thead>
        <tbody>
