<div class="box form">
    ...
    <?php echo $this->Form->create('Congreso', array('class' => 'form-inline container-fluid upper float-messages')); ?>
    <fieldset>
    ...
    <fieldset>
        ...
        <div class="row-fluid">
            ...
            <span>Deseo agregar archivos, al guardar este Congreso.</span>
        </div>
    </fieldset>
