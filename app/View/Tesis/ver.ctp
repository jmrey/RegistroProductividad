<div class="box form">
    ...
    <header>
        ...
        <div class="btn-group right">
            <?php 
                echo $this->Html->link('Editar', array('action' => 'editar', $t['id']),
                    array('class' => 'btn btn-small'));
                $icon_plus = $this->Html->tag('i', '', array('class' => 'icon-plus'));
                echo $this->Html->link($icon_plus . ' Nueva Tesis', array('action' => 'agregar'),
                    array('class' => 'btn btn-small', 'escape' => false));
                $icon_plus = $this->Html->tag('i', '', array('class' => 'icon-minus'));
                echo $this->Form->postLink($icon_plus . ' Borrar', array('action' => 'borrar', $t['id']),
    ...
    <article class="document">
        <div>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <span class="label">Tipo Tesis:</span>
                    <?php echo $tipo_tesis[$t['tipo_tesis']]; ?>
        ...
        <div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <?php echo $t['lista_autores']; ?>
                </div>
            </div>
            <div class="row-fluid">
                <div class="span12">
                    <span class="label">Lista de Autores:</span>
                    <?php echo $t['lista_directores']; ?>
                </div>
            </div>
        </div>
        <div>
            ...
            <div class="row-fluid">
                <div class="span12 no-label">
                    <?php
                        echo $this->Html->link('Ver Archivos', '/'. $this->params['controller'] . '/' . $t['id'] . '/archivos', 
